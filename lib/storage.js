...
// Data directory is configurable so a host can point it at a persistent disk
// (e.g. Render mounts one at /var/data via the DATA_DIR env var). Defaults to
// the in-repo ./data folder for local development.
